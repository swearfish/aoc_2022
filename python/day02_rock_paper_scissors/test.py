...
from day02_rock_paper_scissors.main import get_score_from_file, SCORE_TABLE_PART_ONE, SCORE_TABLE_PART_TWO


class Test(TestCase):
    def test_example_score(self):
        self.assertEqual(15, get_score_from_file('example.in', SCORE_TABLE_PART_ONE))

    def test_input_score(self):
        self.assertEqual(9651, get_score_from_file('input.in', SCORE_TABLE_PART_ONE))
